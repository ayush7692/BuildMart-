...
const uploadToCloudinary = require("../middleware/claudinaryMiddleware.js");
const GeneratedPlan = require("../models/generateImageModel.js");

const UPLOADS_DIR = path.join(process.cwd(), "upload");
